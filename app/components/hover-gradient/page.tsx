...
//       <div className='text-white text-5xl font-merriweather font-medium'>Glowbutton</div>
//       <div className='text-[#7f7f7f] font-sans '>
//       Enhance your UI with a stunning Glow Button that emits a soft, radiant glow on hover.
//       </div>
//       <div className='flex space-x-2 items-center py-1 px-3 rounded-md'>
//         <IconLayoutDashboard stroke={1} className='text-[#7f7f7f]' />
//         <div className='text-[#7f7f7f] font-sans text-base font-semibold flex hover:text-white cursor-pointer'>Preview</div>
//       </div>
//       <div className="rounded-lg border border-[#313131] w-auto  h-screen flex justify-center items-center p-5">
//         <div className='  flex justify-center items-center mx-44 space-x-32'>
//              <Glowbutton  text="Glowbutton"/>
//         </div>
      ...
      <div className="bg-vieww bg-cover bg-no-repeat bg-center h-[722px] w-screen flex gap-2 pt-14 px-5 overflow-hidden ">
        ...
        <div className="h-full w-[70%] ">
          ...
          <div className="text-[#7f7f7f] font-sans text-sm font-medium mx-12">
            Enhance your UI with a stunning Gradient Button that emits a soft, radiant
