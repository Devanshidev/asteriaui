...
import "react-toastify/dist/ReactToastify.css";
 import Typewriter from "@/app/component/Typewriter";
    ...
    <div> 
      ...
      <div className="bg-vieww bg-cover bg-no-repeat bg-center h-[722px] w-screen flex gap-2 pt-14 px-5 overflow-hidden ">
        ...
        <div className="h-full w-[70%] ">
          ...
          Bring your text to life with a dynamic typewriter effect! Watch as letters appear one by one.
          </div>
          <div className="flex justify-center items-center h-full  -mt-20">
          <Typewriter fullText="Welcome to Asteria UI !"/>
          </div>
        </div>
