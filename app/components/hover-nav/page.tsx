...
import HoverNav from '@/app/component/HoverNav'; // Import Clipboard Icon
    ...
    <div> 
      ...
      <div className="bg-vieww bg-cover bg-no-repeat bg-center h-[722px] w-screen flex gap-2 pt-14 px-5 overflow-hidden ">
        ...
        <div className="h-full w-[70%] ">
          ...
          An intuitive hover navigation bar that enhances user experience with smooth transitions and interactive effects.
          </div>
