...
import SetUpAds from '@/app/component/SetupAds';
    ...
    <div> 
      ...
      <div className="bg-vieww bg-cover bg-no-repeat bg-center h-[722px] w-screen flex gap-2 pt-14 px-5 overflow-hidden ">
        ...
        <div className="h-full w-[70%] ">
          ...
          A sleek and responsive dropdown menu that elegantly reveals additional options when triggered.
          </div>
          <div className="flex justify-center items-center h-full  -mt-20 mx-20">
   
          <div className='w-full'>
    <Dropdown heading="Select Option" option1="Option 1" option2="Option 2" option3="Option 3"/>
    </div>
    <div className='w-full'>  
      <SetUpAds  heading="Select Option" 
    option1="Option 1" option2="Option 2" option3="Option 3"/> </div>
        </div>
